# Changelog
## <cg>v4.5.0</c> (2026-07-05) — <cy>BetterInfo+</c>
* <cg>Added</c> <cl>visibility filter</c> button (all / public / unlisted / unlisted-only / friends-only) to <co>level browsers</c>
* <cg>Added</c> <cl>page sort</c> button (downloads / likes / newest / oldest) to <co>level browsers</c>
* <cg>Added</c> <cl>completed filter</c> button (hide / only completed) to <co>level browsers</c>
* <cg>Added</c> <cl>copy level IDs</c> button to <co>level browsers</c>
* <cg>Added</c> <cl>visibility badges</c> (UNLISTED / FRIENDS ONLY) to <co>level cells</c>
* <cg>Added</c> <cl>global sort</c> button to the <co>filtered search view</c>
* <cy>Forked</c> as <cl>BetterInfo+</c> (Windows only)
...
* <cg>Removed</c> integration with <co>QOLmod</c>
